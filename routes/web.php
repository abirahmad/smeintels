...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('sell-target', 'SellTargetController');
    ...
    Route::get('/reports/target-achievement-report', 'ReportController@getTargetAchievementReport');
    Route::get('/reports/product-quotation-report', 'ReportController@getproductQuotationReport');
    ...
    Route::resource('stock-transfers', 'StockTransferController');
       ...
       //opening stock
    Route::get('/opening-stock-list', 'OpeningStockController@index')->name('opening_stock.index');
    ...
    Route::post('/opening-stock/mass-delete', 'OpeningStockController@massDestroy');
