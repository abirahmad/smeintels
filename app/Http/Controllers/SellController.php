...
class SellController extends Controller
{
    ...
    public function create()
    {
        ...
        $areas=Area::where('business_id',$business_id)->pluck('name','id')->toArray();
    ...
    public function edit($id)
    {
        ...
        $sell_details = TransactionSellLine::
                        ...
                        ->select(
                            ...
                            'variations.profit_percent as profit_percent',
                            'variations.custom_profit_percent as custom_profit_percent',
  ...
  $areas=Area::where('business_id',$business_id)->pluck('name','id')->toArray();
        return view('sell.edit')
            ->with(compact('business_details', 'taxes', 'sell_details', 'transaction', 'commission_agent', 'types', 'customer_groups', 'pos_settings', 'waiters', 'invoice_schemes', 'default_invoice_schemes', 'redeem_details', 'edit_discount', 'edit_price', 'shipping_statuses', 'warranties', 'statuses', 'sales_orders', 'payment_types', 'accounts','areas'));
    }
