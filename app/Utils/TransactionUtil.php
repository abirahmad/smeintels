...
class TransactionUtil extends Util
{
    ...
    public function createSellTransaction($business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
        ...
        $transaction = Transaction::create([
            ...
            'mpo' => !empty($input['mpo']) ? $input['mpo'] : null,
            // 'territory' => !empty($input['territory']) ? $input['territory'] : null,
        ...
        foreach ($products as $product) {
            ...
            if (!empty($product['transaction_sell_lines_id'])) {
                ...
                $variation = Variation::findOrFail($product['variation_id']);
                    if (!is_null($variation) && $product['profit_percent'] !== 0) {
                        $variation->profit_percent = $product['profit_percent'];
                        $variation->custom_profit_percent = $product['custom_profit_percent'];
                        $variation->save();
                    }
            } else {
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        $output = [
            ...
            'purchase_price' => $il->purchase_price,
            'show_purchase_price' => $il->show_purchase_price,
        ...
        //MPO
        $output['mpo']=$transaction->mpo;
        
        //Territory
        // $output['territory']=$transaction->territory;
