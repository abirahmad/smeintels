	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
				...
				@endif
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							{!! Form::select('area_id', $areas, $areas->id ?? null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
						</div>
					</div>
			...
			@component('components.widget', ['class' => 'box-solid'])
			    ...
			    <div class="col-md-2">
			    	<div class="form-group">
			            {!! Form::label('mpo', __('MPO') . ':' ) !!}
			            <div class="input-group">
			               {!! Form::text('mpo', '', ['class' => 'form-control direct_sell_rp_input' ]); !!}
			            </div>
			        </div>
			    </div>
			    <div class="col-md-2">
			    	<div class="form-group">
			            {!! Form::label('Territory', __('Territory') . ':' ) !!}
			            <div class="input-group">
			               {!! Form::text('territory', '', ['class' => 'form-control direct_sell_rp_input' ]); !!}
			            </div>
			        </div>
			    </div>
