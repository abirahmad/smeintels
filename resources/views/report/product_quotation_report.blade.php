@extends('layouts.app')
@section('title', __('Product Quotation Report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>{{ __('Product Quotation Report')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'product_quotation_report_form' ]) !!}
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('area_id', __('Area') . ':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                            {!! Form::select('area_id', $areas, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="psr_detailed_tab">
                        <div class="table-responsive">
                            ...
                            id="product_quotation_report_table">
                                <thead>
                                    <tr>
