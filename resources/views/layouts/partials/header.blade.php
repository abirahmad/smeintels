  ...
  <header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @can('sell.create')
            <a href="{{action('SellController@create')}}" title="@lang('Manual Sell')" data-toggle="tooltip" data-placement="bottom" class="btn btn-flat pull-left m-8 btn-sm mt-10 btn-success">
              <strong><i class="fa fa-th-large"></i> &nbsp; @lang('Sell')</strong>
            </a>
          @endcan
          @can('sell.create')
