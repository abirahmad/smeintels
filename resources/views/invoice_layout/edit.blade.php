      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('purchase_price', $invoice_layout->purchase_price, ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_purchase_price', 1, $invoice_layout->show_purchase_price, ['class' => 'input-icheck']); !!} @lang('Show Purchase Price')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
